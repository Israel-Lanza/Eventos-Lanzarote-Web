...
const About = () => {
    return (
        <div className="p-4 md:p-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Nuestro Proyecto</h2>
            <p className="text-base md:text-lg mb-4">
                Somos estudiantes del último curso de Desarrollo Web y este es nuestro proyecto final. Sin embargo, nuestra intención es ir más allá: queremos darle continuidad para que la gente pueda utilizar esta plataforma y estar siempre al tanto de los últimos eventos que se realizan en la isla.
            </p>
            <p className="text-base md:text-lg mb-4">
